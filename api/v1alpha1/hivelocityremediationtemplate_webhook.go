...
var hivelocityremediationtemplatelog = logf.Log.WithName("hivelocityremediationtemplate-resource")
...
//+kubebuilder:webhook:path=/mutate-infrastructure-cluster-x-k8s-io-v1alpha1-hivelocityremediationtemplate,mutating=true,failurePolicy=fail,sideEffects=None,groups=infrastructure.cluster.x-k8s.io,resources=hivelocityremediationtemplates,verbs=create;update,versions=v1alpha1,name=mhivelocityremediationtemplate.kb.io,admissionReviewVersions=v1

var _ webhook.Defaulter = &HivelocityRemediationTemplate{}
...
func (r *HivelocityRemediationTemplate) ValidateCreate() (admission.Warnings, error) {
	hivelocityremediationtemplatelog.V(1).Info("validate create", "name", r.Name)
	return nil, nil
}

// ValidateUpdate implements webhook.Validator so a webhook will be registered for the type.
func (r *HivelocityRemediationTemplate) ValidateUpdate(_ runtime.Object) (admission.Warnings, error) {
	hivelocityremediationtemplatelog.V(1).Info("validate update", "name", r.Name)
	return nil, nil
}

// ValidateDelete implements webhook.Validator so a webhook will be registered for the type.
func (r *HivelocityRemediationTemplate) ValidateDelete() (admission.Warnings, error) {

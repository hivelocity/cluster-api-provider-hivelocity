...
var _ = BeforeSuite(func() {
	...
	err = (&HivelocityCluster{}).SetupWebhookWithManager(mgr)
	Expect(err).NotTo(HaveOccurred())

	err = (&HivelocityClusterTemplate{}).SetupWebhookWithManager(mgr)
	Expect(err).NotTo(HaveOccurred())
	...
	err = (&HivelocityRemediationTemplate{}).SetupWebhookWithManager(mgr)
	Expect(err).NotTo(HaveOccurred())

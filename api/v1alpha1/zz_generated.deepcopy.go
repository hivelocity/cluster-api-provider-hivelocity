...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HivelocityNetworkSpec) DeepCopyInto(out *HivelocityNetworkSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HivelocityNetworkSpec.
func (in *HivelocityNetworkSpec) DeepCopy() *HivelocityNetworkSpec {
	if in == nil {
		return nil
	}
	out := new(HivelocityNetworkSpec)
	in.DeepCopyInto(out)
	return out
}

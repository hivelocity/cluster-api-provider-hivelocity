...
2. Fork the desired repo, develop and test your code changes.
    1. See the [Development Guide](docs/book/src/developer/index.md) for more instructions on setting up your environment and testing changes locally.
...
In case you want to run our E2E tests locally, please refer to
[Docs / E2E Tests](https://hivelocity.github.io/cluster-api-provider-hivelocity/developer/e2e.html) guide.

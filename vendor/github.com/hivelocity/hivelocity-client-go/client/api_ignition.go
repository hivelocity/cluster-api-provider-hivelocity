...
func (a *IgnitionApiService) DeleteIgnitionResourceId(ctx context.Context, ignitionId int32, localVarOptionals *IgnitionApiDeleteIgnitionResourceIdOpts) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/ignition/{ignitionId}"
	localVarPath = strings.Replace(localVarPath, "{"+"ignitionId"+"}", fmt.Sprintf("%v", ignitionId), -1)
...
func (a *IgnitionApiService) GetIgnitionResource(ctx context.Context, localVarOptionals *IgnitionApiGetIgnitionResourceOpts) ([]IgnitionResponse, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue []IgnitionResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ignition/"
...
/*
IgnitionApiService Creates a new Ignition configuration
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param payload
 * @param optional nil or *IgnitionApiPostIgnitionResourceOpts - Optional Parameters:
     * @param "XFields" (optional.String) -  An optional fields mask
 ...
 * @param ignitionId
 * @param payload
 * @param optional nil or *IgnitionApiPutIgnitionResourceIdOpts - Optional Parameters:
     * @param "XFields" (optional.String) -  An optional fields mask

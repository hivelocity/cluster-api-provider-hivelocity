...
func (a *ServiceApiService) PostServiceIdApplyCouponResource(ctx context.Context, serviceId int32, payload CartCoupon) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/service/{serviceId}/apply-coupon"
	localVarPath = strings.Replace(localVarPath, "{"+"serviceId"+"}", fmt.Sprintf("%v", serviceId), -1)
...
/*
ServiceApiService Validate the coupon code for a service
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param serviceId
 * @param payload
 * @param optional nil or *ServiceApiPostServiceIdValidateCouponResourceOpts - Optional Parameters:
     * @param "XFields" (optional.String) -  An optional fields mask
...
func (a *ServiceApiService) PostServiceIdValidateCouponResource(ctx context.Context, serviceId int32, payload CartCoupon, localVarOptionals *ServiceApiPostServiceIdValidateCouponResourceOpts) (ValidateCartCouponDump, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/service/{serviceId}/validate-coupon"
	localVarPath = strings.Replace(localVarPath, "{"+"serviceId"+"}", fmt.Sprintf("%v", serviceId), -1)
